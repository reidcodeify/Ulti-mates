...
class ActiveAccount: Object, Profilable {
	...
	func provideViewableAccount() -> ViewableAccount {
		return ViewableAccount(name: self.name, friendsList: self.friendsList, favoriteEvents: self.favoriteEvents)
	}
}
...
class ViewableAccount: Object, Profilable {
	...
	convenience init (name: String, friendsList: List<ViewableAccount>, favoriteEvents: List<Event>) {
		self.init()
		self.name = name
